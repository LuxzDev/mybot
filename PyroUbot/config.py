...
BOT_TOKEN = os.getenv("BOT_TOKEN", "7742200345:AAEpzruLhH58xst9Mr98RbtvQfpM4ODx5wo")
...
MONGO_URL = os.getenv("MONGO_URL", "mongodb+srv://luzfimax:BHbHGnX6FQWoMm8S@cluster0.da9fmla.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
